...
excludes every other export member. The two-anchor fixtures cover a matching digest,
a three-key digest under the supported scope, an absent scope, and an unsupported scope.
