...
`asqav-31` through `asqav-34` cover a matching counterparty binding, an incorrect
three-key digest, an absent scope, and an unsupported scope. Each acknowledgment
